...
![图3-1：Common Crawl数据流水线](../images/第3章/图3-1_CommonCrawl数据流水线.png)
...
![图3-2：解析器质量对比](../images/第3章/图3-2_解析器质量对比.png)
...
![图3-3：预训练数据来源混合](../images/第3章/图3-3_预训练数据来源混合.png)
...
**温度采样**是更精细的方法。设定一个温度参数 T，语言 L 的采样概率为 $p_L \propto n_L^{1/T}$，其中 $n_L$ 是该语言的原始数据量。T=1 时退化为原始比例，T→∞ 时接近均匀分布。LLaMA 2 使用了 T=0.3 左右的温度采样。
...
![图3-4：分布式爬虫架构](../images/第3章/图3-4_分布式爬虫架构.png)
...
![图3-5：本章知识结构](../images/第3章/图3-5_本章知识结构.png)
